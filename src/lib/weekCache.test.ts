...
import { clearWeekBrowserCache, CURRENT_WEEK_CACHE_KEY, LAST_WEEK_CACHE_KEY, SESSION_CLASS_DIFFS_KEY } from "./weekCache.js";
...
void describe("roster browser cache", () => {
   ...
   void it("removes persisted roster data and session diff cache", () => {
      ...
      sessionStorage.setItem(SESSION_CLASS_DIFFS_KEY, "cached-diffs");
