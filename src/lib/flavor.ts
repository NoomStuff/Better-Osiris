...
export function getBreakIcon(previousClassEnd: Date, nextClassStart: Date, classIndex: number): string {
   const breakMinutes = Math.round((nextClassStart.getTime() - previousClassEnd.getTime()) / 60_000);
